import { object, string, optional, array, lazy, boolean, number, bigint, dict, validateAndUnmap, validateAndUnmapXml, validateAndMap, validateAndMapXml } from '@apimatic/schema';
...
var CustomersApi = /*#__PURE__*/function (_BaseApi) {
  ...
  function () {
    ...
    function deleteCustomer(_x9, _x10, _x11) {
  ...
  function () {
    ...
    function retrieveCustomer(_x12, _x13) {
  ...
  function () {
    ...
    function updateCustomer(_x14, _x15, _x16) {
  ...
  function () {
    ...
    function createCustomerCard(_x17, _x18, _x19) {
  ...
  function () {
    ...
    function deleteCustomerCard(_x20, _x21, _x22) {
  ...
  function () {
    ...
    function removeGroupFromCustomer(_x23, _x24, _x25) {
  ...
  function () {
    ...
    function addGroupToCustomer(_x26, _x27, _x28) {
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject5$4(), mapped.programId);
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject5$5(), mapped.subscriptionId);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject5$6(), mapped.locationId, mapped.transactionId);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject2$j(), mapped.locationId, mapped.orderId);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              req.json(mapped.body);
              req.appendTemplatePath(_templateObject3$f(), mapped.locationId, mapped.orderId);
...
var DefaultRequestBuilder = /*#__PURE__*/function () {
  ...
  _proto.json = function json(data) {
    this._body = JSON$1.stringify(data);
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 8:
              _context7.prev = 8;
              parsed = JSON$1.parse(result.body);
              _context7.next = 15;
              break;
...
var USER_AGENT = 'Square-TypeScript-SDK/10.0.0';
...
function getBaseUri(server, config) {
  ...
  if (config.environment === Environment.Custom) {
    if (server === 'default') {
      return pathTemplate(_templateObject$r(), new SkipEncode(config.customUrl));
    }
  }
